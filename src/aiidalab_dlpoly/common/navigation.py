...
from aiidalab_dlpoly.utils import open_link_in_new_tab

_APPS_DIRECTORY = "/apps/apps/"


class QuickAccessButtons(ipw.HBox):
    """Quick access buttons present in the app's header and start banner."""
    ...
    def __init__(self, **kwargs):
        ...
        **kwargs :
        ...
        self.docs_link.on_click(
            partial(open_link_in_new_tab, "https://github.com/stfc/aiidalab-dlpoly")
        )
